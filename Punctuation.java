 ...
 * 12-10-2024
 * Punctuation.java
 * This program takes a text input and uses String methods to then output 
 * only the words adjacent to a punctuation symbol.
 */
 ...
 public class Punctuation
 {
	 ...
	 {
		 Punctuation pew = new Punctuation();
		 pew.searchIt();
	 }
	 ...
	 public void searchIt()
	 {
		 ...
		 text = checkForPunctuation(text);
		 printWords(text);
	 }
	 
	 public String getPunctuationWords(String textIn)
	 {
		 textIn = "Blood, Sweat, and Tears by Winston Churchill " +
				  "May 13, 1940 " +
				  "Mr. Speaker: " +
	 ...
	 public String checkForPunctuation(String textIn2)
	 {
		 String word = "";
		 boolean punc = false;
		 String newText = "";
		 while (textIn2.indexOf(" ") != -1)
		 {
			word = textIn2.substring(0, textIn2.indexOf(" "));
			punc = hasPunctuationInWord(word);
			if (punc)
				newText += word + " ";
			textIn2 = textIn2.substring(textIn2.indexOf(" ")).trim();
		} 
		return newText;
	 }
	 
	 public boolean hasPunctuationInWord(String wordIn)
	 {
			for (int i = 0; i < wordIn.length(); i++)
			{
				int charAscii = (int)(wordIn.charAt(i));
				if ((charAscii >= 33) && (charAscii <= 47))
					return true;
			}
			return false;
	 }
	 
	 public void printWords(String textIn3)
	 {
		 System.out.print("\n\n\n");
		 System.out.println("Your new text is: ");
		 System.out.println(textIn3);
		 System.out.print("\n\n\n");
	 }
}
